...
export default function CajaPage() {
  ...
  const PinModal = () => (
    <div style={ST.overlay} onClick={e => { if (e.target === e.currentTarget) setShowPinModal(false) }}>
      <div style={ST.modal}>
        ...
        {/* Indicador de dígitos — solo visual, no afecta el input */}
        ...
        {/* INPUT NO CONTROLADO — sin value prop, sin onChange que cause re-render del campo */}
        <input
          ref={pinInputRef}
          type="password"
          inputMode="numeric"
        ...
        <div style={{ display:'flex', gap:8 }}>
          ...
          >
            {pinLoading ? '⏳ Verificando...' : '✅ Confirmar (Enter)'}
          </button>
        </div>
      </div>
    </div>
